...
//mexfunction is entry point to mex file
//nout is number of expected output
//pout is Array of pointers to the expected output
//nin: Number of input 
//pin is Array of pointers to the input
/*MATLAB: [a,b] = fun(d,e,f).here nout=2, nin=3*/
...
//nxgetn is number of columns in array
